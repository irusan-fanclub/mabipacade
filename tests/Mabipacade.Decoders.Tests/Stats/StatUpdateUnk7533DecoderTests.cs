...
{
    [Fact]
    public void Op_Matches() => Assert.Equal((uint)0x7533, new StatUpdateUnk7533Decoder().Op);

    [Fact]
    public void Decodes_Sample()
    {
        var input = new DecoderInput(DateTime.UtcNow, Direction.Inbound, 0x7533, 0UL,
