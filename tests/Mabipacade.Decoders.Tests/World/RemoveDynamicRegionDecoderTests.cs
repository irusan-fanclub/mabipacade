...
public class RemoveDynamicRegionDecoderTests
{
    ...
    {
        Assert.Equal((uint)0x9572, new RemoveDynamicRegionDecoder().Op);
    }
    ...
    public void Decodes_Sample()
    {
        ...
        var input = new DecoderInput(DateTime.UtcNow, Direction.Inbound, 0x9572, 3458764513820540928UL, elems);
