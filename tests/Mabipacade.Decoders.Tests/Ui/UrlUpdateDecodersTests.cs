...
public class UrlUpdateDecodersTests
{
    ...
    {
        Assert.Equal((uint)0x000065A2, new UrlUpdateChronicleDecoder().Op);
        Assert.Equal((uint)0x000065A3, new UrlUpdateAdvertiseDecoder().Op);
        Assert.Equal((uint)0x000065A4, new UrlUpdateGuestbookDecoder().Op);
        Assert.Equal((uint)0x000065A5, new UrlUpdatePvpDecoder().Op);
        Assert.Equal((uint)0x000065A6, new UrlUpdateDungeonBoardDecoder().Op);
        Assert.Equal((uint)0x00006652, new UrlUpdateReserved1Decoder().Op);
        Assert.Equal((uint)0x00006653, new UrlUpdateReserved2Decoder().Op);
    }
