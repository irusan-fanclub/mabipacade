...
public class PetStat55DecoderTests
{
    ...
    {
        Assert.Equal((uint)0x0000A032, new PetStat55Decoder().Op);
    }
    ...
    public void Decodes_ModeA_NoEntries()
    {
        ...
        var input = new DecoderInput(DateTime.UtcNow, Direction.Inbound, 0x0000A032, 4504699139850743UL, elems);
    ...
    public void Decodes_ModeB_Sample()
    {
        ...
        var input = new DecoderInput(DateTime.UtcNow, Direction.Inbound, 0x0000A032, 4504699144649501UL, elems);
        var result = Assert.IsType<PetStat55>(new PetStat55Decoder().Decode(input));
        Assert.Equal(55, result.GroupId);
