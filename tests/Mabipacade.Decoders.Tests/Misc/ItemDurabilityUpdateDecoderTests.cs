...
{
    [Fact]
    public void Op_Matches() => Assert.Equal((uint)0x5BD5, new ItemDurabilityUpdateDecoder().Op);

    [Fact]
    public void Decodes_Sample()
    {
        var input = new DecoderInput(DateTime.UtcNow, Direction.Inbound, 0x5BD5, 0UL,
