...
{
    [Fact]
    public void Op_Matches() => Assert.Equal((uint)0x000059EE, new ItemUpdateDecoder().Op);

    [Fact]
    public void Decodes_Sample()
    {
        var input = new DecoderInput(DateTime.UtcNow, Direction.Inbound, 0x000059EE, 0UL,
